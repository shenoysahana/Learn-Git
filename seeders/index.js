...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      ...
      'email':'Helena5@hotmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let user = await dbService.updateOne(User, { 'username':'Hermina.Nolan61' }, userToBeInserted,  { upsert: true });
    userToBeInserted = {
      'password':'nixZvkiRiLG7orI',
      'isDeleted':false,
      'username':'Agustina.Klein',
      'email':'Krystina_Kshlerin45@yahoo.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let admin = await dbService.updateOne(User, { 'username':'Agustina.Klein' }, userToBeInserted,  { upsert: true });
